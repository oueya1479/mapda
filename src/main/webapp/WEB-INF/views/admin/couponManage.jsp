                ...
                <div class="col-lg-12">
                    ...
                    <!-- <div class="blog__sidebar__categories" style =" width : 250px; text-align: center;"> -->
                            ...
                            <!-- <ul style="font-size: 25px;"> -->
                                <!-- <li> --><a href="/coupon/admin">전체</a>&nbsp;&nbsp;&nbsp;<!-- </li> -->
                                <c:forEach items="${requestScope.categoryList}" var="cate">
                                	<!-- <li> --><a href="/coupon/admin/?category=${cate.cpcaNo}">${cate.cpcaName}<span></span></a>&nbsp;&nbsp;&nbsp;<!-- </li> -->
                                </c:forEach>
                            <!-- </ul> -->
                    		</div>
...
<!-- 					</div>
 -->                    <div align="center">
                    ...
                    <div class="blog__pagination" style="text-align: center">
                        ...
                        <c:otherwise> 
                        <a href="/coupon/admin/?nowPage=${couponList.number-1}&category=${param.category}&keyword=${param.keyword}"><i class="fa fa-long-arrow-left"></i>Pre</a> 
                        </c:otherwise> 
                        </c:choose>
