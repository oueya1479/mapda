...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/ej/css/combined.css">
...
-->
    <nav class="nk-navbar nk-navbar-full nk-navbar-align-center" id="nk-nav-mobile">
        <div class="nk-navbar-bg">
            <div class="bg-image" style="background-image: url('${pageContext.request.contextPath}/ej/images/bg-menu.jpg')"></div>
        </div>
                    ...
                    <div class="nk-nav-header">
                        ...
                        <div class="nk-nav-logo">
                            <a href="index.html" class="nk-nav-logo">
                                <img src="${pageContext.request.contextPath}/ej/images/logo-light.svg" alt="" width="85">
                            </a>
                        </div>
    ...
    <div class="nk-main">
        ...
        <div class="nk-header-title nk-header-title-lg">
            <div class="bg-image">
                <div style="background-image: url('${pageContext.request.contextPath}/ej/images/post-6-mid.jpg');"></div>
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <div class="nk-comment">
                            <div class="nk-comment-avatar">
                                <a href="#">
                                    <img src="${pageContext.request.contextPath}/ej/images/avatar-1.jpg" alt="">
                                </a>
                            </div>
                            ...
                            <div class="nk-comment">
                                <div class="nk-comment-avatar">
                                    <a href="#">
                                        <img src="${pageContext.request.contextPath}/ej/images/avatar-2.jpg" alt="">
                                    </a>
                                </div>
                                <div class="nk-comment-meta">
                        ...
                        <div class="nk-comment">
                            <div class="nk-comment-avatar">
                                <a href="#">
                                    <img src="${pageContext.request.contextPath}/ej/images/avatar-3.jpg" alt="">
                                </a>
                            </div>
                            <div class="nk-comment-meta">
